        ...
        <div class="thumbnail-hover__overlay">
          ...
          <div class="thumbnail-hover__eye">
            <a href="<?php echo esc_url(get_permalink()); ?>" class="thumbnail-hover__link">
                <img src="<?php echo esc_url(get_template_directory_uri()); ?>/images/Icon_eye.png" alt="icon-eye">
            </a>
          </div>

            <div class="thumbnail-hover__expand">
              <img src="<?php echo esc_url(get_template_directory_uri()); ?>/images/Icon_fullscreen.png" alt="Agrandir">
            </div>
        </div>
